 ...
 */
class RolesPermissions extends \MDM\mdmBundle\Entity\RolesPermissions implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'rol', 'permission');
        }
