 ...
 */
class Users extends \MDM\mdmBundle\Entity\Users implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'login', 'password', 'name', 'surname', 'other', 'email', 'id', 'group');
        }
